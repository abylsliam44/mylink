...
export default function Auth() {
  ...
  const { isLoading, loadingMessage, withLoading } = usePageLoader()
  ...
  return (
    <div className="relative min-h-[calc(100vh-64px-40px)] overflow-hidden">
      {/* Page Loader */}
      <PageLoader show={isLoading} message={loadingMessage} />
      ...
      <PageTransition>
        <div className="container min-h-[calc(100vh-64px-40px)] flex items-center py-8">
